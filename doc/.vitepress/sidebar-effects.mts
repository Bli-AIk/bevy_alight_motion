...
export const zhHansEffects = {
  ...
  items: [
    ...
    { text: '<span style="color:#eab308">●</span> 颜色替换 (Replace Color)', link: '/zh-hans/effects/replace-color' },
...
export const enEffects = {
  ...
  items: [
    ...
    { text: '<span style="color:#eab308">●</span> Replace Color', link: '/en/effects/replace-color' },
