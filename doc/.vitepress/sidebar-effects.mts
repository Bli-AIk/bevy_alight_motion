...
export const zhHansEffects = {
  text: '高级效果',
  items: [
    { text: '<span style="color:#22c55e">●</span> 变换 (Transform2)', link: '/zh-hans/effects/transform2' },
    ...
    { text: '<span style="color:#ef4444">●</span> 阈值 (Threshold)', link: '/zh-hans/effects/threshold' },
...
export const enEffects = {
  ...
  items: [
    { text: '<span style="color:#22c55e">●</span> Transform2', link: '/en/effects/transform2' },
    ...
    { text: '<span style="color:#ef4444">●</span> Threshold', link: '/en/effects/threshold' },
