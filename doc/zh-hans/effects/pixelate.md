...
> ⚠️ **此文档由代码自动生成，请勿手动编辑。**
> 最近测试时间：2026-02-13 03:10:13

降低图像分辨率，产生像素化效果。

**支持状态**: ⚠️ 部分支持

- **大小 (size)**: ✅ 已实现 (像素大小 (1-100))
- **拉伸 (stretch)**: ✅ 已实现 (像素拉伸比例)
- **角度 (angle)**: ✅ 已实现 (像素网格旋转角度)
- **晕影 (vignette)**: ⚠️ 部分实现 (晕影强度 (尚未完全支持))
- **屏幕空间 (screenSpace)**: ⚠️ 部分实现 (是否使用屏幕空间坐标 (尚未完全支持))
