...
pub(super) fn set_mask_repeat_uniforms(
    ...
    let Some(&mask_entity) = pending.spawned_entities.get(&mask_entry.mask_layer_id) else {
        ...
        uniform.mask1_lr_params1 = Vec4::new(-1.0, 0.0, 0.0, 0.0);
        uniform.mask1_lr2_params1 = Vec4::new(-1.0, 0.0, 0.0, 0.0);
        uniform.mask1_repeat_params1 = Vec4::ZERO;
    ...
    if rp_count > 0.0 {
        ...
        uniform.mask1_repeat_params1 =
            Vec4::new(rp_count.floor(), off_world_x, off_world_y, rp_angle);
        uniform.mask1_repeat_params2 = Vec4::new(rp_scale, rp_alpha, 0.0, 0.0);
    } else {
        uniform.mask1_repeat_params1 = Vec4::ZERO;
        uniform.mask1_repeat_params2 = Vec4::new(1.0, 1.0, 0.0, 0.0);
    }
    ...
    if !disable_mask_linear_repeat && count > 0.0 {
        ...
        uniform.mask1_lr_params1 = Vec4::new(count, pos_world_x, pos_world_y, angle);
    ...
    if let Some(ref lr2) = animated.linear_repeat2 {
        ...
        if count2 > 0.0 {
            ...
            uniform.mask1_lr2_params1 = Vec4::new(count2, pos2_world_x, pos2_world_y, angle2);
            uniform.mask1_lr2_params2 = Vec4::new(off2_world_x, off2_world_y, scale2, alpha2);
            uniform.mask1_lr2_params3 = Vec4::new(start2, end2, phase2, overlap2);
            uniform.mask1_lr2_params4 = Vec4::new(ease_in2, ease_out2, 0.0, sia2 as f32);
            uniform.mask1_lr2_params5 = if lr2.random_order {
