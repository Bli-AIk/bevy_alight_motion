...
pub(crate) fn collect_embed_scene(
    ...
    let radial_repeat_effect = extract_radial_repeat_effect(&embed.effects);
    ...
    PendingLayer {
        ...
        embed_render_plan: Some(crate::effects::EmbedSceneRenderPlan::new(
            embed.fill_type == "intrinsic"
                || radial_repeat_effect.count.value.is_some_and(|v| v > 0.0)
                || !radial_repeat_effect.count.keyframes.is_empty(),
